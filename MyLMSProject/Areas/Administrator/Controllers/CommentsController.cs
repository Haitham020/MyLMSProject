...
namespace MyLMSProject.Areas.Administrator.Controllers
{
    ...
    public class CommentsController : Controller
    {
        ...
        public CommentsController(LmsDbContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Create([Bind("CommentId,CommentText,CommentCreatedAt,IsActive,IsDeleted")] Comment comment)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("CommentId,CommentText,CommentCreatedAt,IsActive,IsDeleted")] Comment comment)
        {

...
namespace MyLMSProject.Areas.Administrator.Controllers
{
    ...
    public class CategoriesController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("CategoryId,CategoryName,IsActive,IsDeleted")] Category category)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("CategoryId,CategoryName,IsActive,IsDeleted")] Category category)
        {

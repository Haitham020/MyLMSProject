...
namespace MyLMSProject.Areas.Administrator.Controllers
{
    ...
    public class MenusController : Controller
    {
        ...
        public MenusController(LmsDbContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Create([Bind("MenuId,MenuTitle,MenuUrl,MenuController,ParentId")] Menu menu)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("MenuId,MenuTitle,MenuUrl,MenuController,ParentId")] Menu menu)
        {
            if (id != menu.MenuId)
            {
                return NotFound();
